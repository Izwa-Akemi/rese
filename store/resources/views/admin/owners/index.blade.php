                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 hidden md:block">メールアドレス</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @method('delete')
                                            <td class="px-4 py-3">
                                                <button data-id="{{$owner->id}}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded">削除</button>
                                            </td>
                                            </form>
                                        </tr>
                                        @endforeach
